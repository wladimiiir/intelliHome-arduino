...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/app.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/app.exe: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1360930230/thermostat.o: ../lib/thermostat.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I${INCLUDE} ${FLAGS_GPP} -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360930230/thermostat.o ../lib/thermostat.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/app.exe
